...
var modelSchema  = new Schema({
    ...
    "QualityService" : { type: String, default: "Normal"},
    ...
    "AdjustPct" : { type: Number, default: 0},
    "FixedAdjustPerKm" : { type: Number, default: 0},
    "Currency" : { type: String, default: "VND"}

}, { timestamps: { createdAt: 'createdAt' } },
{ collection: 'TaxiDiscount' });


modelSchema.index({PickupCenterLoc :1});
// create model if not exists.
module.exports = mongoose.model('TravelComPriceAdjust',modelSchema);
