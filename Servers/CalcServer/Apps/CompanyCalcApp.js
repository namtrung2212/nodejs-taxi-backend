...
app=require("../../../Base/BaseCalcApp")("Company");
...
function refreshCompanyStatistic(){

          console.log("refresh Company Statistic");
          ...
          TravelOrder.aggregate()
                      ...
                      .exec(function (err, data) {
                          ...
                          data.forEach(function(obj){
                                ...
                                Company.findOneAndUpdate( {_id: obj._id},
                                                          {
